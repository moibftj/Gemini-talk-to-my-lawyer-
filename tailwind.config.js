  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'legal-gradient': 'linear-gradient(135deg, #1e3a8a 0%, #3b82f6 50%, #1d4ed8 100%)',
      ...
      boxShadow: {
        ...
        'legal': '0 10px 25px -3px rgba(30, 58, 138, 0.1), 0 4px 6px -2px rgba(30, 58, 138, 0.05)',
      },
      // Custom Animations
      animation: {
